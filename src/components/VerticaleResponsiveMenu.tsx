...
function VerticaleResponsiveMenu({closed, status}: {closed: MouseEventHandler, status: boolean}){
    return (
        <div className={status ? visible : invisible}>
            <Link className="my-2 hover:bg-gray-700 w-full mx-0" onClick={closed} to="/">Accueil</Link>
